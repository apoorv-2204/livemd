defmodule Faucetprovider do
  @moduledoc """
  Documentation for `Faucetprovider`.
  """


  def main() do
    wallet_address = "0000c084b09c60e3bde2d0a81df08b20d82d8b6dfc1d39bc3dfa5e41b731718f09e1"
    withdraw_uco({:http,"localhost",4000},wallet_address)
  end
  ...
  def get_request_header(content_length) do
    [
      ...
      {"cookie" ,"_archethic_key=SFMyNTY.g3QAAAABbQAAAAtfY3NyZl90b2tlbm0AAAAYbnFtT0lVWE9ZZmVIVHZHQVdHenJKTzh2.AuLNklbvM6lHiGY2yGN6mmoDBNrcGqSL5v206ghydFs"}
    ]
  end

  def get_request_body(wallet_address) do
    body =  "_csrf_token=DCcfJAc6Bz1sVl0ebAx-NhIlSgMMIH8DbVrkNo_r508V8z9wEb0qFoGu&address=#{wallet_address}"
